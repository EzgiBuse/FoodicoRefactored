...
builder.Services.AddSwaggerGen(option =>
{
    ...
    {
        Name = "Authorization",
        Description = "Enter the Bearer Auth string",
...
void ApplyMigration()
{//Automatically applying migrations when the app is run
